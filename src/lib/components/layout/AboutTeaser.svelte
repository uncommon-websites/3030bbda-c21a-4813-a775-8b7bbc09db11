...
<script lang="ts">
  ...
  name: "Thilo Konzok",
  role: "Founder of Uncommon",
  image: "/generated/image-a-professional-headshot-of-an-early-30s-.webp"
};
</script>
...
<section bind:this={sectionRef} {...props}>
	<div class="section-px section-py container mx-auto">
        ...
        text={`"After raising, selling, and hiring the hard way, I built Uncommon to make the early days easier."`}
      />
